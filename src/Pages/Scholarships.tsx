const scholarshipData = [
	...
	},
	{
		...
		schemes: [
			[
				"Mukhya Mantri Medhavi Vidyarthi Yojana - MMVY",
	...
	},
	{
		...
		schemes: [
			[
				"Post-Matric (Outside State) Scholarship for ST/SC/BC/EBC/Disabled Welfare",
	...
	},
	{
		...
		schemes: [
			[
				"Post-Matric (Outside State) Scholarship for ST/SC",
	...
	},
	{
		...
		schemes: [
			...
			[
				"Prime Minister's Scholarship Scheme For CAPF & Assam Rifles",
			...
			[
				"PM Scholarship Scheme For Wards of States/UTs Police Personnel Martyred in Terror/NAXAL Attacks",
		...
		<div className="bg-gray-100 min-h-screen flex flex-col">
			...
			<main className="max-w-5xl mx-auto p-6 bg-white shadow-lg rounded-lg mt-8">
				...
				<h2 className="text-xl font-semibold text-gray-800 mt-6 mb-4">
					State-wise Scholarship Schemes
				</h2>
					...
					<table className="w-full border border-gray-300 text-gray-700">
						...
						<tbody>
							{scholarshipData.map((stateData, index) =>
								stateData.schemes.map(
									([scheme, governedBy, link], schemeIndex) => (
										<tr key={`${index}-${schemeIndex}`} className="border">
											{schemeIndex === 0 ? (
												<td
													rowSpan={stateData.schemes.length}
