		...
		<div className="bg-gray-100 text-gray-900 min-h-screen">
			...
			<div className="max-w-4xl mx-auto px-4 md:px-6 py-8 text-center">
				<p className="text-base md:text-lg text-gray-700">
					IIIT Nagpur offers a wide range of academic programs through its
					dedicated departments. Each department focuses on cutting-edge
					research, industry collaborations, and hands-on learning experiences
					to equip students with the knowledge and skills required for the
					future. Discover the diverse fields of study and explore the
					opportunities each department provides.
				</p>
			</div>
