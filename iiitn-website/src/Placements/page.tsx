			...
			<div className="bg-gray-100 min-h-screen flex flex-col">
				...
				<div className="flex flex-col  p-6 m-4 rounded-lg bg-white shadow-lg">
					...
					<p className="text-gray-700 leading-relaxed">
						...
						importance. It takes various initiatives to transform the students
						into a smart workforce. The T&P Office believes in providing quality
						internships and placements to all its students. Consistent efforts
						are made to collaborate with leading organizations for joint
						technological development and research initiatives, internships, and
						placements. It acts as a Resource Centre, where students get
						information about various training programs, online courses,
						internships, and projects at various Govt Organizations in India.
					</p>
					<p className="mt-4">
						The T&P office is headed by the Sr. Office Associate T&P, Dr. Meera
						Jgadale, and supported by faculty In-charge Dr. Paritosh Peshwe and
					...
					<div className="p-4 border rounded-lg shadow-md bg-gray-50 mt-6">
						...
						<p className="text-gray-700 leading-relaxed">
							Campus Recruitment Training is a crucial aspect of the placement
							preparations. Students at IIITN are critically trained on aspects
							like Aptitude, Group Discussions, and Interview skills. They are
							also encouraged to take up entrepreneurship through interaction
				...
				<div className="flex flex-col  p-6 m-4 rounded-lg bg-white shadow-lg">
					...
					<p className="text-gray-700 leading-relaxed">
						IIIT Nagpur is home to highly skilled and innovative students
						trained in various domains of technology and research. The rigorous
						academic curriculum and hands-on industry exposure ensure that our
					...
					<div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
						<div className="p-4 border rounded-lg shadow-md bg-gray-50">
							...
							<p className="text-gray-700">
								...
								Parliament. Admissions happen through JoSAA. Only top 2%
						...
						<div className="p-4 border rounded-lg shadow-md bg-gray-50">
							...
							<p className="text-gray-700">
								...
								tech experts from IT industry. Choice Based Credit System allows
								students to choose subjects of interest. Credit-based mandatory
						...
						<div className="p-4 border rounded-lg shadow-md bg-gray-50">
							...
							<p className="text-gray-700">
								Ack-Z: A white hat security club. DotSlash: Programming
