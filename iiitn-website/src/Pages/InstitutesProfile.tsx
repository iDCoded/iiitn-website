  ...
  return (
    <div className="bg-gray-100 min-h-screen flex flex-col items-center text-gray-800">
      ...
      <div className="max-w-4xl bg-white shadow-lg rounded-lg p-8 my-10">
        <h2 className="text-3xl font-semibold text-[#002147] mb-4"><span className="text-[#E87722] text-4xl mr-2">|</span>Institute Profile</h2>
        ...
        <h3 className="text-2xl font-semibold text-[#002147] mt-6"><span className="text-[#E87722] text-4xl mr-2">|</span>Institute’s Mandate</h3>
        <p className="text-justify leading-relaxed">
        ...
        <h3 className="text-2xl font-semibold text-[#002147] mt-6"><span className="text-[#E87722] text-4xl mr-2">|</span>Institute’s Vision</h3>
        <p className="text-justify leading-relaxed">
        ...
        <h3 className="text-2xl font-semibold text-[#002147] mt-6"><span className="text-[#E87722] text-4xl mr-2">|</span>Institute’s Mission</h3>
        <p className="text-justify leading-relaxed">
