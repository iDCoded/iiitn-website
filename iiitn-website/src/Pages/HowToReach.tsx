		...
		<div className="bg-gray-100 min-h-screen flex flex-col">
			...
			<section className="max-w-5xl mx-auto bg-white p-6 shadow-lg rounded-lg mt-10">
				...
				<p className="text-gray-700 mt-3 leading-relaxed">
					The campus is located in <b>Waranga, Buti Bori, Nagpur</b>, well
					connected by <b>rail, air, and road transport</b>.
				</p>

				<div className="mt-4">
					<h3 className="text-2xl font-semibold text-primary">🚉 By Rail</h3>
					<p className="text-gray-700 mt-1">
						Nagpur Main Railway Station - <b>20 KM</b>
					</p>
				</div>
				...
				<div className="mt-4">
					...
					<p className="text-gray-700 mt-1">
						Dr. Babasaheb Ambedkar International Airport (Nagpur) - <b>8 KM</b>
					</p>
				</div>
				...
				<div className="mt-4">
					...
					<p className="text-gray-700 mt-1">
						Nagpur Central Bus Stand - <b>22 KM</b>
					</p>
				</div>
			</section>
