      ...
      <section className="max-w-6xl mx-auto py-12 px-6 bg-white shadow-lg rounded-lg mt-8">
        ...
        <div className="space-y-4 text-gray-700 leading-relaxed">
          ...
          <ul className="list-disc pl-6">
            ...
            <li>Boards, Councils, Committees constituted as part of the Public Authority</li>
          </ul>
        </div>
      </section>
          ...
          <table className="w-full border-collapse border border-gray-300 text-gray-700">
            ...
            <tbody>
              {rtiReports.map((report, index) => (
                <tr key={index} className="text-center border border-gray-300 bg-gray-50 hover:bg-gray-100">
      ...
      <section className="max-w-6xl mx-auto py-12 px-6 bg-white shadow-lg rounded-lg mt-8 mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="p-6 bg-gray-50 shadow-md rounded-lg">
            <h3 className="text-2xl font-semibold text-blue-700">Central Public Information Officer</h3>
            <p className="mt-2"><strong>Ms. Shilpa Pawankar</strong>, Assistant Registrar (Accounts)</p>
            <p className="text-gray-600">Indian Institute of Information Technology, Nagpur</p>
            <p className="mt-2"><strong>Phone:</strong> 8080339345</p>
            <p><strong>Email:</strong> <a href="mailto:aracct@iiitn.ac.in" className="text-blue-600 hover:underline">aracct@iiitn.ac.in</a></p>
          </div>

          {/* First Appellate Authority */}
          <div className="p-6 bg-gray-50 shadow-md rounded-lg">
            <h3 className="text-2xl font-semibold text-blue-700">First Appellate Authority</h3>
            <p className="mt-2"><strong>Shri Kailas N. Dakhale</strong>, Registrar</p>
            <p className="text-gray-600">Indian Institute of Information Technology, Nagpur</p>
            <p className="mt-2"><strong>Phone:</strong> 8087983449</p>
            <p><strong>Email:</strong> <a href="mailto:registrar@iiitn.ac.in" className="text-blue-600 hover:underline">registrar@iiitn.ac.in</a></p>
          </div>
        </div>
      </section>
    </div>
