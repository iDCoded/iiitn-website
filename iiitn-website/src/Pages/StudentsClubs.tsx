...
const studentClubs = [
  ...
  { name: "Dimensions (AR, VR, XR Wing)", category: "Technical Club", link: "#" },
  { name: "Udyam (E-cell/Innovation/IPR Wing)", category: "Technical Club", link: "#" },
  { name: "CRISPR (Central Research Initiative and Student Public Relations)", category: "Technical Club", link: "#" },
  ...
  { name: "Orator (Debate and Public Speaking Wing)", category: "Cultural Club", link: "#" },
  { name: "Probe (Social Media, Photography, Videography, Magazine Wing)", category: "Cultural Club", link: "#" },
  { name: "Eklavya (Sports Club for Kshitij)", category: "Sports Club", link: "#" },
];
    ...
    <div className="bg-gray-100 min-h-screen flex flex-col">
      ...
      <div className="max-w-5xl mx-auto px-6 pb-12">
        ...
        <p className="text-gray-600">
          ...
          workshops, debates, quizzes, and more.
        </p>
        <a
          href="/pages/elclub"
          className="inline-block mt-4 bg-primary text-white px-4 py-2 rounded-md text-sm font-medium hover:bg-[#001a36] transition"
