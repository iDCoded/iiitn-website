			...
			<main className="max-w-6xl mx-auto px-6 py-10 space-y-10">
				...
				<section className="bg-white shadow-md rounded-lg p-8">
					<h2 className="text-3xl font-semibold text-gray-900 mb-4">
						<span className="text-accent font-bold text-4xl">| </span>About
						Electoral Literacy Club
					</h2>
					<p className="text-gray-700 leading-relaxed">
						The Election Commission of India is an autonomous constitutional
						authority responsible for administering election processes at
						national, state, and district levels. The Electoral Literacy Club
						aims to educate young voters and promote active participation in the
						democratic process.
					</p>
					<a
						href="#"
				...
				<section className="bg-white shadow-md rounded-lg p-8">
					<h2 className="text-3xl font-semibold text-gray-900 mb-6">
						<span className="text-accent font-bold text-4xl">| </span>Contests &
						Initiatives
					</h2>
				...
				<section className="bg-white shadow-md rounded-lg p-8">
					<h2 className="text-3xl font-semibold text-gray-900 mb-6">
						<span className="text-4xl text-accent font-bold">| </span>Upcoming &
						Past Events
					</h2>
					<p className="text-gray-700 mb-6">
						Here is a list of events organized by the Electoral Literacy Club to
						spread awareness and encourage civic participation.
					</p>
					<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
