    ...
    <div className="bg-gray-100 min-h-screen flex flex-col items-center text-gray-800">
      ...
      <div className="max-w-6xl bg-white shadow-lg rounded-lg p-8 my-10">
        ...
        <div className="grid md:grid-cols-2 gap-10">
          {[
            { title: "Academic Block", img: acad, description: "State-of-the-art classrooms and lecture halls with modern teaching aids." },
            { title: "Library", img: libray, description: "A vast collection of books, journals, and digital resources for students and faculty." },
            { title: "Gym", img: gym, description: "Fully equipped gymnasium to promote fitness and well-being." },
            { title: "Microprocessor Lab", img: micro, description: "Advanced microprocessor training and research facility." },
            { title: "Control System Lab", img: control_dignal, description: "Laboratory for control systems and automation studies." },
            { title: "Computer Programming Lab", img: cplab, description: "Well-equipped lab for hands-on programming and software development." },
            { title: "Database Lab", img: db, description: "Dedicated lab for database management and research." },
            { title: "Data Structure & Algorithm Lab", img: da, description: "Practical exposure to data structures and algorithm design." },
