const pressData = [
	...
	{
		title: "IIIT Nagpur Joins Smart City Project",
		date: "2023-01-05",
		link: "#",
	},
	{ title: "Advanced Robotics Lab Opens", date: "2022-12-20", link: "#" },
	{
		title: "IIIT Nagpur Placement Report Released",
		date: "2022-11-10",
		link: "#",
	},
	{
		title: "International Symposium on Cybersecurity",
		date: "2022-09-15",
		link: "#",
	},
	{ title: "Launch of New Data Science Course", date: "2022-08-10", link: "#" },
	{
		title: "IIIT Nagpur Celebrates Foundation Day",
		date: "2022-07-01",
		link: "#",
	},
	{ title: "Partnership with Global Tech Firm", date: "2022-06-05", link: "#" },
	{
		title: "AI-Based Healthcare Solution Developed",
		date: "2022-05-15",
		link: "#",
	},
	{
		title: "IIIT Nagpur Signs MoU with IIT Bombay",
		date: "2022-04-01",
		link: "#",
	},
	{
		title: "IIIT Nagpur Ranks Among Top Institutes",
		date: "2022-03-15",
		link: "#",
	},
];
		...
		<div className="bg-gray-100 min-h-screen flex flex-col">
			...
			<div className="max-w-6xl mx-auto p-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
				{latestPressReleases.map((press, index) => (
					<div
						key={index}
						className="bg-white shadow-lg p-5 rounded-lg hover:shadow-2xl transition-shadow duration-300">
						...
						<a
							href={press.link}
							className="text-accent hover:text-orange-600 font-medium mt-2 inline-block">
							Read More →
						</a>
					</div>
				))}
