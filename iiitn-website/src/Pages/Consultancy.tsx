	...
	return (
		<div className="bg-gray-100 min-h-screen flex flex-col">
			...
			<main className="max-w-6xl mx-auto p-6 space-y-10">
				...
				<section className="bg-white shadow-lg rounded-lg p-6 border-t-4 border-[#E87722]">
					...
					<ul className="space-y-3 text-gray-700">
						<li className="flex justify-between items-center border-b pb-3">
							...
							<a href="#" className="px-4 py-2 text-white bg-[#E87722] rounded-md hover:bg-[#c2651c] transition">
								More Details
							</a>
						</li>
				...
				<section className="bg-white shadow-lg rounded-lg p-6 border-l-4 border-[#002147]">
					<h2 className="text-2xl font-semibold text-[#002147] mb-4">
						Industrial Research & Consultancy
					</h2>
				...
				{/* Project Types */}
				<section className="bg-white shadow-lg rounded-lg p-6 border-t-4 border-[#E87722]">
					<h2 className="text-2xl font-semibold text-[#002147] mb-4">Project Types</h2>
					<div className="grid md:grid-cols-2 gap-6">
						<div className="p-5 border border-gray-300 rounded-lg bg-[#f5f5f5] hover:shadow-md transition">
							<h3 className="text-lg font-medium text-[#002147]">Consultancy Projects</h3>
						...
						<div className="p-5 border border-gray-300 rounded-lg bg-[#f5f5f5] hover:shadow-md transition">
							<h3 className="text-lg font-medium text-[#002147]">Sponsored Research Projects</h3>
							<ul className="list-disc list-inside text-gray-700 mt-2 space-y-2">
				...
				<section className="bg-white shadow-lg rounded-lg p-6 border-l-4 border-[#002147]">
					<h2 className="text-2xl font-semibold text-[#002147] mb-4">Completed & Ongoing Projects</h2>
				...
				<section className="bg-white shadow-lg rounded-lg p-6 border-t-4 border-[#E87722]">
					<h2 className="text-2xl font-semibold text-[#002147] mb-4">Sponsored Research Labs & Facilities</h2>
					<p className="text-gray-700 leading-relaxed">
						Industries can sponsor research labs at IIIT Nagpur, supporting research infrastructure and fostering
						industry-academia collaborations.
					</p>
					<div className="grid sm:grid-cols-2 gap-4 mt-4">
						<a href="#" className="block bg-[#E87722] text-white p-4 rounded-md shadow-md text-center hover:bg-[#c2651c] transition">
