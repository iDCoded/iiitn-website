const achievementsData = [
	{
		...
		description:
			"A nationwide initiative to provide students with a platform to solve pressing problems and inculcate a mindset of problem-solving.",
	},
	{
		title: "Atal Ranking of Institutions on Innovation Achievements (ARIIA)",
		description:
			"An initiative to systematically rank educational institutions on their innovation achievements.",
	},
	{
		title: "National Innovation and Start-up Policy (NISP)",
		description:
			"A policy framework to nurture innovation and start-up culture in higher educational institutions.",
	},
];
...
const facultyData = [
	...
	},
	{
		...
		post: "IIC Vice President",
	},
	{
		name: "Dr. C. D. Verma",
		designation: "Associate Professor",
		post: "IIC Coordinator",
	},
	{
		name: "Dr. E. F. Gupta",
			...
			<div className="max-w-6xl mx-auto p-6 space-y-8">
				...
				<section className="bg-white shadow-lg rounded-lg p-6">
					...
					<p className="text-gray-700">
						In 2018, the Ministry of Education (MoE) through MoE’s Innovation
						Cell (MIC) established the Institution’s Innovation Council (IIC)
						program to systematically foster innovation and a start-up ecosystem
				...
				<section className="bg-white shadow-lg rounded-lg p-6">
					...
					<h3 className="text-xl font-semibold text-center text-gray-900 mb-4">
						Institute Innovation Council at IIIT Nagpur for Academic Year
						2024-2025
					</h3>
