		...
		<div className="bg-gray-100 min-h-screen flex flex-col">
			...
			<section className="max-w-5xl mx-auto bg-white p-8 shadow-lg rounded-lg mt-10">
				...
				<p className="text-gray-700 leading-relaxed">
					The **Grievance Committee SC/ST Cell (GCC)** is established to address
					caste-based grievances at IIIT Nagpur. The committee is responsible
					for investigating complaints, verifying facts, and ensuring a fair
					resolution process.
				</p>
			</section>
						...
						<tbody>
							{committeeMembers.map((member, index) => (
								<tr
									...
									<td className="py-3 px-6 border font-semibold">
										{member.designation}
									</td>
								</tr>
							))}
			...
			<section className="max-w-5xl mx-auto mt-10 p-8 bg-white shadow-lg rounded-lg">
				...
				<p className="text-gray-700 leading-relaxed">
					If you have any grievances or need assistance, please reach out to the
					**Grievance Committee SC/ST Cell**. All matters will be handled with
					confidentiality and fairness.
				</p>
			</section>

			{/* Footer */}
			<footer className="text-center py-6 text-gray-600 text-sm mt-10 bg-primary">
