		...
		<div className="bg-gray-100 min-h-screen flex flex-col">
			...
			<main className="max-w-4xl mx-auto p-6 bg-white shadow-lg rounded-lg mt-8">
				...
				<section className="mb-6">
					<h2 className="text-xl font-semibold text-gray-800 mb-3">Hostel Bank Details</h2>
					<div className="bg-gray-100 p-4 rounded-md shadow-sm">
						<p className="text-gray-700"><strong>Name of Account:</strong> {hostelFeeData.accountName}</p>
						<p className="text-gray-700"><strong>Account No:</strong> {hostelFeeData.accountNumber}</p>
						<p className="text-gray-700"><strong>IFSC Code:</strong> {hostelFeeData.ifscCode}</p>
						<p className="text-gray-700"><strong>Branch Name:</strong> {hostelFeeData.branchName}</p>
					</div>
				</section>
				...
				{/* QR Code for Payment */}
				<section className="mb-6">
					<h2 className="text-xl font-semibold text-gray-800 text-center">Hostel Fees QR Code</h2>
