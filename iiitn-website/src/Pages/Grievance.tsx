  ...
  return (
    <div className="bg-gray-100 min-h-screen">
      ...
      <section className="max-w-5xl mx-auto bg-white p-6 shadow-lg rounded-lg mt-10">
        <h2 className="text-3xl font-semibold text-[#002147]"><span className="text-[#E87722] text-4xl">| </span>About the Portal</h2>
      ...
      <main className="max-w-6xl mx-auto mt-10 p-6">
        <h2 className="text-3xl font-bold text-[#002147] mb-6 text-left"><span className="text-[#E87722] text-4xl">| </span> Submit a Grievance</h2>
      ...
      <section className="max-w-5xl mx-auto mt-10 p-6 bg-white shadow-lg rounded-lg">
        <h2 className="text-3xl font-semibold text-[#002147]"><span className="text-[#E87722] text-4xl">| </span> How It Works?</h2>
