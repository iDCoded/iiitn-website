  ...
  return (
    <div className="bg-gray-100 min-h-screen">
      ...
      <section className="max-w-5xl mx-auto bg-white p-6 shadow-lg rounded-lg mt-10">
        <h2 className="text-3xl font-semibold text-[#002147]">About the Portal</h2>
      ...
      <main className="max-w-6xl mx-auto mt-10 p-6">
        <h2 className="text-3xl font-bold text-[#002147] mb-6 text-center">📌 Submit a Grievance</h2>
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          <a href="#" className="block bg-[#002147] text-white text-center py-4 rounded-lg shadow-md hover:bg-[#001730] transition">
      ...
      <section className="max-w-5xl mx-auto mt-10 p-6 bg-white shadow-lg rounded-lg">
        <h2 className="text-3xl font-semibold text-[#002147]">🔍 How It Works?</h2>
        <ul className="list-disc pl-6 mt-3 text-gray-700 space-y-3">
          <li>📌 Submit your complaint under the relevant category.</li>
          <li>📌 The concerned authorities will validate and review the complaint.</li>
          <li>📌 Once resolved, a response will be provided to the complainant.</li>
          <li>📌 All grievances are handled with confidentiality and fairness.</li>
        </ul>
      </section>
