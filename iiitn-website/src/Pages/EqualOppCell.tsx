...
function EqualOpportunityCell() {
  ...
  const committeeMembers = [
    { id: 1, name: "Dr. Anil Kumar Kushwah", designation: "Chairman, Asst. Professor (CSE)" },
    { id: 2, name: "Dr. Kamaljeet", designation: "Member, Asst. Professor (BS)" },
    { id: 3, name: "Mr. Ashok Dongare", designation: "Member, Junior Engineer (Civil)" },
    { id: 4, name: "Ms. Nilobha Mahajan", designation: "Member, Junior Assistant (Multi-Skilled)" },
    { id: 5, name: "Mr. Jigar Shah", designation: "Member, Parent" },
    { id: 6, name: "Mr. Nenavath Chandra Shekhar", designation: "Member, Student (BT22CSH040)" },
  ];
